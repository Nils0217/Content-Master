...
# "automarketer" here is the name of an existing hotdata.dev catalog/database
# created before this project was renamed to ContentMaster — it's an
# external resource name, not the project's own name. Don't "fix" it to
# match the new project name; that would just point at a different (empty)
# catalog. hotdata.dev itself is slated for retirement anyway — see
# docs/WHITEPAPER.md §3 and docs/SCHEDULE.md Phase 0.
