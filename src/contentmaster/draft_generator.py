        ...
        * Each draft declares what it IS and what it is TESTING, reusing
        ...
        if controls and prior:
            prompt += (
                ...
                "AND the opening tells us nothing: whatever it scores, there is no way to say "
                "which change caused it.\n"
                "Name that one thing in EVIDENCE-AGAINST, and put the same thing in TESTING as "
                "the axis. Writing `none` in EVIDENCE-AGAINST means you did not do it, so do not "
        ...
        prompt += (
            ...
            "not the placeholders. Never leave this blank: a post that varies nothing cannot "
